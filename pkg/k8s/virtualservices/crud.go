...
func Create(ctx context.Context, vs *istioV1beta1.VirtualService, c *istioclientset.Clientset) error {
...
func Update(ctx context.Context, vs *istioV1beta1.VirtualService, c *istioclientset.Clientset) error {
...
func Get(ctx context.Context, name, namespace string, c *istioclientset.Clientset) (*istioV1beta1.VirtualService, error) {
	return c.NetworkingV1beta1().VirtualServices(namespace).Get(ctx, name, metav1.GetOptions{})
}

// List list istio virtual services
func List(ctx context.Context, namespace string, c *istioclientset.Clientset) ([]*istioV1beta1.VirtualService, error) {
